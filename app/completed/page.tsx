    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container py-8">
        <div className="card p-8 max-w-4xl mx-auto border border-gray-200 rounded-lg shadow-sm">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Completed Tasks</h2>
          <p className="text-gray-600 text-lg leading-relaxed">View your completed tasks and achievements</p>
          <div className="mt-6">
